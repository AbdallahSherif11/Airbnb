...
namespace Airbnb.Core.Services.Contract.HouseServices.Contract
{
    public interface IHouseService
    {
        ...
        Task<ReadHouseDTO> GetHouseByIdForUpdate(int id);

        Task<IEnumerable<ReadHouseDTO>> GetHousesByHostAsync(string hostId);
        ...
        Task<IEnumerable<ReadHouseDTO>> GetHousesByViewAsync(string view);
